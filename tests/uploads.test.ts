import fs from 'fs';
import type { ResponseLike } from 'nimbus-storage/internal/to-file';
import { toFile } from 'nimbus-storage/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('nimbus-storage/core/uploads');
    await expect(
