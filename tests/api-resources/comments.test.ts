...
describe('resource comments', () => {
  ...
  test.skip('retrieve', async () => {
    const responsePromise = client.comments.retrieve('12345');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('retrieve: request options and params are passed correctly', async () => {
    ...
    await expect(
      client.comments.retrieve('12345', { fields: ['string'] }, { path: '/_stainless_unknown_path' }),
    ).rejects.toThrow(NimbusStorage.NotFoundError);
  });

  // Prism tests are disabled
  test.skip('update', async () => {
    const responsePromise = client.comments.update('12345');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('update: request options and params are passed correctly', async () => {
    ...
    await expect(
      client.comments.update(
        '12345',
        { fields: ['string'], message: 'Review completed!' },
  ...
  test.skip('delete', async () => {
    const responsePromise = client.comments.delete('12345');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
